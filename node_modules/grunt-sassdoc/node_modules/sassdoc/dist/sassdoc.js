...
function sassdoc() {
  ...
  return srcEnv(documentize, stream).apply(undefined, args);
...
function srcEnv(documentize, stream) {
  return function () {
    ...
    env.logger.debug('env:', function () {
      ...
      (0, _lodashDifference2['default'])(_Object$getOwnPropertyNames(env), ['domain', '_events', '_maxListeners', 'logger']).forEach(function (k) {
